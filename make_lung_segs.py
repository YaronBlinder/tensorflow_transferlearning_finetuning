...
for i in tqdm(range(10)):
    ...
    seg_norm_im = seg_image(normal_path, Nmask_path='results/Nmask.png')
    ...
    seg_abnorm_im = seg_image(abnormal_path, Nmask_path='results/Nmask.png')
    segmented_normal_path = data_folder + 'lung_seg/2/' + abnormal_filename
